...
package cn.aizichan.android.support.v4.internal.view;

import cn.aizichan.android.support.v4.view.ActionProvider;
import cn.aizichan.android.support.v4.view.MenuItemCompat;
...
public interface SupportMenuItem extends android.view.MenuItem {
    ...
    */
     ...
     * provider set via {@link #setSupportActionProvider(cn.aizichan.android.support.v4.view.ActionProvider)}. </p>
     *
    ...
    /**
     * Sets the {@link cn.aizichan.android.support.v4.view.ActionProvider} responsible for creating an action view if
     ...
     * @return This Item so additional setters can be called.
     * @see cn.aizichan.android.support.v4.view.ActionProvider
     */
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
     ...
     * @see cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener
     */
    public boolean isActionViewExpanded();

    /**
     * Set an {@link cn.aizichan.android.support.v4.view.MenuItemCompat.OnActionExpandListener} on this menu item to be notified when the associated
