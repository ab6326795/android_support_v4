 ...
 * Original file: D:\\android_work\\aizichan_v4\\src\\cn\\aizichan\\android\\support\\v4\\media\\session\\IMediaControllerCallback.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements cn.aizichan.android.support.v4.media.session.IMediaControllerCallback
{
private static final java.lang.String DESCRIPTOR = "cn.aizichan.android.support.v4.media.session.IMediaControllerCallback";
...
/**
 * Cast an IBinder object into an cn.aizichan.android.support.v4.media.session.IMediaControllerCallback interface,
 * generating a proxy if needed.
 */
public static cn.aizichan.android.support.v4.media.session.IMediaControllerCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cn.aizichan.android.support.v4.media.session.IMediaControllerCallback))) {
return ((cn.aizichan.android.support.v4.media.session.IMediaControllerCallback)iin);
}
return new cn.aizichan.android.support.v4.media.session.IMediaControllerCallback.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.session.PlaybackStateCompat _arg0;
if ((0!=data.readInt())) {
_arg0 = cn.aizichan.android.support.v4.media.session.PlaybackStateCompat.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.MediaMetadataCompat _arg0;
if ((0!=data.readInt())) {
_arg0 = cn.aizichan.android.support.v4.media.MediaMetadataCompat.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> _arg0;
_arg0 = data.createTypedArrayList(cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem.CREATOR);
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo _arg0;
if ((0!=data.readInt())) {
_arg0 = cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
private static class Proxy implements cn.aizichan.android.support.v4.media.session.IMediaControllerCallback
{
...
@Override public void onPlaybackStateChanged(cn.aizichan.android.support.v4.media.session.PlaybackStateCompat state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onMetadataChanged(cn.aizichan.android.support.v4.media.MediaMetadataCompat metadata) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onQueueChanged(java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> queue) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onVolumeInfoChanged(cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo info) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void onPlaybackStateChanged(cn.aizichan.android.support.v4.media.session.PlaybackStateCompat state) throws android.os.RemoteException;
public void onMetadataChanged(cn.aizichan.android.support.v4.media.MediaMetadataCompat metadata) throws android.os.RemoteException;
public void onQueueChanged(java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> queue) throws android.os.RemoteException;
...
public void onVolumeInfoChanged(cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo info) throws android.os.RemoteException;
}
