 ...
 * Original file: D:\\android_work\\aizichan_v4\\src\\cn\\aizichan\\android\\support\\v4\\media\\session\\IMediaSession.aidl
 */
package cn.aizichan.android.support.v4.media.session;
/**
...
public static abstract class Stub extends android.os.Binder implements cn.aizichan.android.support.v4.media.session.IMediaSession
{
private static final java.lang.String DESCRIPTOR = "cn.aizichan.android.support.v4.media.session.IMediaSession";
...
/**
 * Cast an IBinder object into an cn.aizichan.android.support.v4.media.session.IMediaSession interface,
 * generating a proxy if needed.
 */
public static cn.aizichan.android.support.v4.media.session.IMediaSession asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cn.aizichan.android.support.v4.media.session.IMediaSession))) {
return ((cn.aizichan.android.support.v4.media.session.IMediaSession)iin);
}
return new cn.aizichan.android.support.v4.media.session.IMediaSession.Stub.Proxy(obj);
}
...
cn.aizichan.android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper _arg2;
if ((0!=data.readInt())) {
_arg2 = cn.aizichan.android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper.CREATOR.createFromParcel(data);
}
else {
_arg2 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.session.IMediaControllerCallback _arg0;
_arg0 = cn.aizichan.android.support.v4.media.session.IMediaControllerCallback.Stub.asInterface(data.readStrongBinder());
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo _result = this.getVolumeAttributes();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.RatingCompat _arg0;
if ((0!=data.readInt())) {
_arg0 = cn.aizichan.android.support.v4.media.RatingCompat.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.MediaMetadataCompat _result = this.getMetadata();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
cn.aizichan.android.support.v4.media.session.PlaybackStateCompat _result = this.getPlaybackState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> _result = this.getQueue();
reply.writeNoException();
...
private static class Proxy implements cn.aizichan.android.support.v4.media.session.IMediaSession
{
...
@Override public void sendCommand(java.lang.String command, android.os.Bundle args, cn.aizichan.android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper cb) throws android.os.RemoteException
{
...
@Override public void registerCallbackListener(cn.aizichan.android.support.v4.media.session.IMediaControllerCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterCallbackListener(cn.aizichan.android.support.v4.media.session.IMediaControllerCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo getVolumeAttributes() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getVolumeAttributes, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void rate(cn.aizichan.android.support.v4.media.RatingCompat rating) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public cn.aizichan.android.support.v4.media.MediaMetadataCompat getMetadata() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
cn.aizichan.android.support.v4.media.MediaMetadataCompat _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getMetadata, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = cn.aizichan.android.support.v4.media.MediaMetadataCompat.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public cn.aizichan.android.support.v4.media.session.PlaybackStateCompat getPlaybackState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
cn.aizichan.android.support.v4.media.session.PlaybackStateCompat _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getPlaybackState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = cn.aizichan.android.support.v4.media.session.PlaybackStateCompat.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> getQueue() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getQueue, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public void sendCommand(java.lang.String command, android.os.Bundle args, cn.aizichan.android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper cb) throws android.os.RemoteException;
public boolean sendMediaButton(android.view.KeyEvent mediaButton) throws android.os.RemoteException;
public void registerCallbackListener(cn.aizichan.android.support.v4.media.session.IMediaControllerCallback cb) throws android.os.RemoteException;
public void unregisterCallbackListener(cn.aizichan.android.support.v4.media.session.IMediaControllerCallback cb) throws android.os.RemoteException;
...
public cn.aizichan.android.support.v4.media.session.ParcelableVolumeInfo getVolumeAttributes() throws android.os.RemoteException;
...
public void rate(cn.aizichan.android.support.v4.media.RatingCompat rating) throws android.os.RemoteException;
public void sendCustomAction(java.lang.String action, android.os.Bundle args) throws android.os.RemoteException;
public cn.aizichan.android.support.v4.media.MediaMetadataCompat getMetadata() throws android.os.RemoteException;
public cn.aizichan.android.support.v4.media.session.PlaybackStateCompat getPlaybackState() throws android.os.RemoteException;
public java.util.List<cn.aizichan.android.support.v4.media.session.MediaSessionCompat.QueueItem> getQueue() throws android.os.RemoteException;
